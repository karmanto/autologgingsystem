        ...
        <div class="drop-down">
            ...
            <div class="drop-down__menu-box">
                <ul class="drop-down__menu">
                    ...
                    <li class="drop-down__item" onclick="window.location.replace('activeMachine-html.php'+'?eraseCache=true')">Active Machine
                        <svg class="drop-down__item-icon">
                    ...
                    <li class="drop-down__item" onclick="window.location.replace('profil-html.php'+'?eraseCache=true')">Admin
                        <svg class="drop-down__item-icon">
